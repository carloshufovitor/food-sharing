      ...
      <div class="relative">
        <div class="lg:grid lg:grid-flow-row-dense lg:grid-cols-2 lg:gap-8 lg:items-center">
          <div
            ...
            class="ml-auto lg:col-start-2 lg:max-w-2xl"
          >
            ...
            <h4 class="mt-2 text-2xl font-extrabold leading-8 text-gray-900 dark:text-white sm:text-3xl sm:leading-9">
              Sharing surplus food, reducing waste — together we make a
              difference.
            </h4>
            <p class="mt-4 text-lg leading-6 text-gray-500 dark:text-gray-300">
              Connect with your local community by donating or requesting
              surplus food easily. Our platform ensures fresh food reaches those
              in need efficiently and securely.
            </p>
