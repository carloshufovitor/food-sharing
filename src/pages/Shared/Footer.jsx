...
const Footer = () => {
  return (
    <div>
      <footer className="px-4 divide-y bg-gradient-to-r from-[#f8fbf6] to-[#e9f3e3] dark:text-gray-800">
        <div className="container flex flex-col justify-between py-10 mx-auto space-y-8 lg:flex-row lg:space-y-0">
          ...
          <div className="grid text-black text-sm gap-x-3 gap-y-8 lg:w-full lg:ml-4 md:grid-cols-3 lg:grid-cols-4">
            <div className="space-y-3">
              ...
              <ul className="space-y-1">
                <Link to="/available-foods">
                  <li>
                    <p className="hover:text-[#73B21A]">Available Foods</p>
                  </li>
                </Link>
                <Link to="/add-food">
                  <li>
                    <p className="hover:text-[#73B21A]">Add Food</p>
                  </li>
                </Link>
                <Link to="/manage-my-foods">
                  <li>
                    <p className="hover:text-[#73B21A]">Manage My Foods</p>
                  </li>
                </Link>
                <Link to="/my-food-request">
                  <li>
                    <p className="hover:text-[#73B21A]">My Food Request</p>
                  </li>
                </Link>
              </ul>
            </div>
            ...
            <div className="space-y-3">
              ...
              <ul className="space-y-1">
                <Link to="/privacy-policy">
                  <li>
                    <p className="hover:text-[#73B21A]">Privacy Policy</p>
                  </li>
                </Link>
                <Link to="/terms-and-condition">
                  <li>
                    <p className="hover:text-[#73B21A]">Terms and Conditions</p>
                  </li>
                </Link>
                <Link to="/contact-us">
                  <li>
                    <p className="hover:text-[#73B21A]">Contact Us</p>
                  </li>
                </Link>
              </ul>
            </div>
            ...
            <div className="space-y-3">
              ...
              <ul className="space-y-1">
                ...
                <li>
                  <p className="hover:text-[#73B21A]">
                    {" "}
                    Email: support@fosharing.com
                  </p>
                </li>
                <li>
                  <p className="hover:text-[#73B21A]"> Phone: 01751 202 502</p>
                </li>
                <li>
                  <p className="hover:text-[#73B21A]">
                    Business Hour: 9AM - 5 PM
                  </p>
                </li>
              </ul>
            </div>
            ...
            <div className="space-y-3 md:ml-4">
              <div className="uppercase dark:text-gray-900 text-[16px] font-bold">
                Social media
              </div>
              <div className="flex justify-start space-x-3">
                ...
                <a
                  rel="noopener noreferrer"
                  href="https://www.linkedin.com/in/raseduzzaman-rased/"
                  title="LinkedIn"
                  className="flex items-center p-1"
                >
                  <svg
                    ...
                    className="w-5 h-5 fill-current"
                  >
                    <path d="M19 0h-14c-2.76 0-5 2.24-5 5v14c0 2.76 2.24 5 5 5h14c2.76 0 5-2.24 5-5v-14c0-2.76-2.24-5-5-5zm-11 19h-3v-10h3v10zm-1.5-11.27c-.97 0-1.75-.79-1.75-1.75s.78-1.75 1.75-1.75 1.75.79 1.75 1.75-.78 1.75-1.75 1.75zm13.5 11.27h-3v-5.5c0-1.32-1.68-1.22-1.68 0v5.5h-3v-10h3v1.42c1.4-2.58 5-2.77 5 2.47v6.11z" />
                  </svg>
                </a>
